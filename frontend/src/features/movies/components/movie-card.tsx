...
import { HoverPreviewCard, MoviePreviewData } from '@/shared/components/ui';
...
export default function MovieCard({ movie, enablePreview = true, priority = false }: MovieCardProps) {
    ...
    // Randomize poster on mount
    const displayPoster = useMemo(() => getRandomImage(movie.posters, movie.posterUrl), [movie]);
    const displayBackdrop = useMemo(() => getRandomImage(movie.backdrops, movie.backdropUrl), [movie]);
        ...
        <div className="group relative w-full">
            ...
            >
                ...
                <div className="relative w-full aspect-[2/3] overflow-hidden rounded-lg bg-gray-800 ring-1 ring-white/10 shadow-lg">
                    ...
                    {!imageLoaded && !imageError && displayPoster && (
