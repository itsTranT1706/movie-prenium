...
import { ArrowBigUp, ArrowBigDown, MessageSquare, Pencil, Trash2, MoreHorizontal } from 'lucide-react';
                    ...
                    {!isEditing && (
                        <div className="flex items-center gap-4 mt-2">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                {/* 3-dot menu for Edit/Delete (owner only) */}
                                {isOwner && (
                                    <div className="relative">
                                        <button
                                            onClick={() => {
                                                const menu = document.getElementById(`menu-${comment.id}`);
                                        ...
                                        <div
                                            id={`menu-${comment.id}`}
                                            className="hidden absolute right-0 top-full mt-1 bg-zinc-800 border border-zinc-700 rounded-lg shadow-xl py-1 z-20 min-w-[120px]"
                                        >
                                            <button
                                                onClick={() => {
                                                    setIsEditing(true);
                                                ...
                                                className="w-full px-3 py-2 text-left text-sm text-zinc-300 hover:bg-white/10 flex items-center gap-2"
                                            >
